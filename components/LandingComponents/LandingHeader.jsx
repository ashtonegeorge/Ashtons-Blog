...
const LandingHeader = () => {
  ...
  if (width <= 425) {
    logo = <div className='mt-6 mb-6'><AnimatedLogo /></div>
  ...
  return (
    <div className="relative h-[80vh] md:h-[115vh] bg-zinc-900 px-8 overflow-hidden font-ubuntu w-full pt-6 md:pt-0">
      <div>
      ...
      <div id='content' className='pt-[10vh] block md:flex justify-around align-middle'>
        ...
        <motion.div
          ...
          initial='inactive'
          animate='active'
          className='xl:w-[46rem] lg:w-[40rem] md:w-[30rem] w-[90vw] text-zinc-400 my-auto pt-2 md:pt-0'
        >
